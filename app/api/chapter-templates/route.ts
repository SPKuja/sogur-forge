...
export async function POST(request:NextRequest){
  ...
  const created=await query(`INSERT INTO "ChapterTemplate" ("id","novelId","name","isDefault","eyebrowPattern","titlePattern","showImage","imageWidth","imageAlign","createdAt","updatedAt") VALUES ($1,$2,$3,$4,'CHAPTER {{chapter_number_roman}}','{{chapter_title}}',false,100,'CENTER',NOW(),NOW()) RETURNING "id","name","isDefault","eyebrowPattern","titlePattern","showImage","headerImageAssetId","imageWidth","imageAlign","imagePosition","imageSpacing","labelAlign","labelSize","labelWeight","labelFont","labelSpacing","labelColor","labelCase","titleAlign","titleSize","titleWeight","titleFont","titleSpacing","titleColor","titleCase","showDivider","dividerWidth","dividerThickness","headerPaddingTop","headerPaddingBottom"`,[id,novelId,name,isDefault]);
