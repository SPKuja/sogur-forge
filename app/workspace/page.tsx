...
export default async function WorkspacePage(){
 ...
 return <Library username={user.username} novels={result.rows.map(n=>({...n,updatedAt:n.updatedAt.toISOString(),wordCount:Number(n.wordCount),chapterCount:Number(n.chapterCount)}))} release={CURRENT_RELEASE} showWhatsNew={seen.rows[0]?.lastSeenVersion!==CURRENT_VERSION}/>;
}